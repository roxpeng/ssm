        ...
        init: function() {
            ...
            var oTable = $('#simpledatatable').dataTable({
                ...
                "oTableTools": {
                    ...
                    "sSwfPath": "assets/swf/copy_csv_xls_pdf.swf"/*tpa=/ssm/staticdatatable/assets/swf/copy_csv_xls_pdf.swf*/
                },
                "language": {
                    "search": "",
                    "sLengthMenu": "_MENU_",
...
var InitiateEditableDataTable = function() {
    return {
        init: function() {
            ...
            //Edit A Row
            $('#editabledatatable').on("click", '/ssm/staticdatatable/a.edit', function(e) {
                e.preventDefault();
            ...
            //Save an Editing Row
            $('#editabledatatable').on("click", '/ssm/staticdatatable/a.save', function(e) {
                e.preventDefault();
    ...
    return {
        init: function() {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                var sOut = '<table>';
                sOut += '<tr><td rowspan="5" style="padding:0 10px 0 0;"><img src="assets/img/avatars/' + aData[6] + '"/*tpa=/ssm/staticdatatable/assets/img/avatars/' + aData[6] + '*//></td><td>Name:</td><td>' + aData[1] + '</td></tr>';
