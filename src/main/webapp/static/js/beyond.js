...
if (location.pathname != "../../index-rtl-fa.html"/*tpa=http://beyondadmin-v1.6.0.s3-website-us-east-1.amazonaws.com/index-rtl-fa.html*/ && location.pathname != "../../index-rtl-ar.html"/*tpa=http://beyondadmin-v1.6.0.s3-website-us-east-1.amazonaws.com/index-rtl-ar.html*/) {
    if (readCookie("rtl-support")) {
        ...
        $('.navbar-brand small img').attr('src', 'assets/img/logo-rtl.png'/*tpa=/ssm/staticassets/img/logo-rtl.png*/);
        if (rtlchanger != null)
    ...
    $("#sidebar-collapse").on('click', function () {
        ...
        if (b) {
            ...
            if ($('.page-sidebar').hasClass('sidebar-fixed')) {
                var position = (readCookie("rtl-support") || location.pathname == "../../index-rtl-fa.html"/*tpa=http://beyondadmin-v1.6.0.s3-website-us-east-1.amazonaws.com/index-rtl-fa.html*/ || location.pathname == "../../index-rtl-ar.html"/*tpa=http://beyondadmin-v1.6.0.s3-website-us-east-1.amazonaws.com/index-rtl-ar.html*/) ? 'right' : 'left';
