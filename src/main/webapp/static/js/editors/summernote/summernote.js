                ...
                '<div class="note-image-popover popover bottom in" style="display: none;">' +
                  ...
                  '<div class="popover-content note-image-content">' +
                    '<div class="btn-group">' +
                      ...
                      '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.image.resizeQuarter + '" data-event="resize" data-value="/ssm/staticeditors/summernote/0.25" tabindex="-1"><span class="note-fontsize-10">25%</span> </button>' +
                    '</div>' +
                    '<div class="btn-group">' +
                 ...
                 '<div class="modal-dialog">' +
                   '<div class="modal-content">' +
                     '<div class="modal-body">' +
                       ...
                       '<p class="text-center"><a href="http://hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.1</a> · <a href="http://github.com/HackerWins/summernote" target="_blank">Project</a> · <a href="http://github.com/HackerWins/summernote/issues" target="_blank">Issues</a></p>' +
                     '</div>' +
                   '</div>' +
                 '</div>' +
               '</div>';
